	...
	<main class="main" role="main">
		<div class="main-body animated fadeIn">
			<div class="main-box main-box-center">
	            ...
	            <img role="button" class="brand brand-main menu-toggle paralik-hang" src="<?php echo get_template_directory_uri() . "/img/logos/main.svg"; ?>" width="200" height="200" data-toggle="toggleClass" data-toggle-value="contractInward" data-target="#main-menu" title="<?php bloginfo('name'); ?>">
